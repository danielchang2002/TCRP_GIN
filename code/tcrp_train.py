...
parser.add_argument(
    "--num_updates", type=int, default=10, help="Number of training epochs"
)
parser.add_argument(
    "--num_inner_updates", type=int, default=1, help="Initial learning rate"
)
parser.add_argument(
    "--num_out_updates", type=int, default=20, help="Final learning rate"
)
parser.add_argument(
...
train_feature, train_label, tissue_index_list = load_data(
    tissue_map, drug, K, path=feature_dic
)
